...
static const char col_gray2[]       = "#d2b4de";
static const char col_gray3[]       = "#a569bd";
static const char col_gray4[]       = "#2e4053";
...
static const Key keys[] = {
  ...
  { MODKEY,                       XK_p,      spawn,          SHCMD("~/scripts/volume_up.sh") },
  ...
  { MODKEY,                       XK_u,      spawn,          SHCMD("~/scripts/dmenu/play_music.sh") },
